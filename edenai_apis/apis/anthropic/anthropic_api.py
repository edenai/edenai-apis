...
class AnthropicApi(
    ...
    def __calculate_usage(self, original_response: dict):
        """
        ...
        Returns:
            dict: None update the original_response with the usage dict
        """
    ...
    def text__generation(
        ...
        # Calculate tokens usage for the old API
        try:
            ...
            raise ProviderException("Client Error", code=500) from exc
    ...
    def text__summarize(
        ...
        self.__calculate_usage(original_response)
