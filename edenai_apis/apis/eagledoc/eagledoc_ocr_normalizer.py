...
def eagledoc_financial_parser(original_response: dict) -> FinancialParserDataClass:
    ...
    merchant_information = FinancialMerchantInformation(
        ...
        registration=dict_get(original_response, "general", "CompanyRegistrationNumber", "value"),
    ...
    financial_payment_information = FinancialPaymentInformation(
        ...
        amount_tip = float(dict_get(original_response, "general", "Tip", "value")) if dict_get(original_response, "general", "Tip", "value") is not None else None,
        ...
        payment_auth_code= dict_get(original_response, "general", "TransactionAuthCode", "value"),
        shipping_handling_charge=None,
        transaction_number= dict_get(original_response, "general", "Transaction", "value"),
        transaction_reference = dict_get(original_response, "general", "TransactionRef", "value"),
    )
    ...
    financial_document_information = FinancialDocumentInformation(
        ...
        service_start_date=dict_get(original_response, "general", "DeliveryDate1", "value"),
        service_end_date=dict_get(original_response, "general", "DeliveryDate2", "value"),
        reference=None,
        biller_code=None,
        order_date=None,
