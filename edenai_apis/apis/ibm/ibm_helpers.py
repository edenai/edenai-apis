...
audio_format_list_extensions= [
    ...
    ("mp3", "mp3", False, []), ("mulaw", "mulaw", True, []), ("ogg", "ogg", False, []),
    ("ogg-opus", "ogg", False, [48000, 24000, 16000, 12000, 8000]), ("ogg-vorbis", "ogg", False, []),
    ("wav", "wav", False, []), ("webm", "webm", False, None), ("webm-opus", "webm", False, None), ("webm-vorbis", "webm", False, [])
]
