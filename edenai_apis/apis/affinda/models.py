...
class Organization(BaseModel):
    """This model are use to represent an Organization
...
class Extractor(BaseModel):
    """This model are use to represent

    Fields:
        identifier (str): The extractor's unique id
        name (str): The extractor's unique name
        category (str): The extractor's category (Ex: 'resume', 'invoice')
...
class Collection(BaseModel):
    """This model are use to represent a collection
...
class Workspace(BaseModel):
    """This model are use to represent a workspace
...
class DocumentMeta(BaseModel):
    """This model are use to represent all of the document's meta data like filename or id
...
class Document(BaseModel):
    """This model are use to represent a Document
