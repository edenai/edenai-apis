class SubCategoryPattern:
    ...
    class Sexual:
        ...
        NUDITY = ["nudity", "graphic male nudity", "graphic female nudity", "illustrated explicit nudity"]
        PARTIAL_NUDITY = ["partial nudity", "barechested male"]
        SUGGESTIVE = ["female swimwear or underwear", "male swimwear or underwear", "suggestive",
                      "suggestive_nudity_content", "sexually suggestive"]
    ...
    class Violence:
        ...
        """
        GRAPHIC_VIOLENCE_OR_GORE = ["death, harm & tragedy", "violence/graphic", "graphic violence or gore", "gore",
                                    "gore_content", "emaciated bodies", "corpses", "hanging", "air crash",
                                    "explosions and blasts"]
        PHYSICAL_VIOLENCE = ["self-harm", "self-harm/intent", "self-harm/instructions", "physical violence",
                             "self injury"]
        WEAPON_VIOLENCE = ["firearms & weapons", "war & conflict", "weapon violence", "weapons", "weapon_content"]
    ...
    class DrugAndAlcohol:
        ...
        """
        DRUG_PRODUCTS = ["drug products", "pills", "drug paraphernalia", "drug", "drug_content", "illicit drugs"]
        DRUG_USE = ["drug use"]
