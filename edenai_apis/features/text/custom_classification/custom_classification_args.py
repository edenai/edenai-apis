...
def custom_classification_arguments(provider_name: str):
    return {
        "texts": ["Confirm your email address", "hey i need u to send some $", "Congratulations! You've won a free vacation! Click the link to claim your prize now!",
                  "Make money fast! Join our exclusive program and start earning thousands in just a few days!", "Get rich quick with this amazing investment opportunity. Guaranteed returns!",
