...
class FinancialPaymentInformation(BaseModel):
    amount_due: Optional[float] = Field(default=None, description="Amount due for payment.")
    amount_tip: Optional[float] = Field(default=None, description="Tip amount in a financial transaction.")
    amount_shipping: Optional[float] = Field(default=None, description="Shipping cost in a financial transaction.")
    amount_change: Optional[float] = Field(default=None, description="Change amount in a financial transaction.")
    amount_paid: Optional[float] = Field(default=None, description="Amount already paid in a financial transaction.")
    total: Optional[float] = Field(default=None, description="Total amount in the invoice.")
    subtotal: Optional[float] = Field(default=None, description="Subtotal amount in a financial transaction.")
    total_tax: Optional[float] = Field(default=None, description="Total tax amount in a financial transaction.")
    tax_rate: Optional[float] = Field(default=None, description="Tax rate applied in a financial transaction.")
    discount: Optional[float] = Field(default=None, description="Discount amount applied in a financial transaction.")
    gratuity: Optional[float] = Field(default=None, description="Gratuity amount in a financial transaction.")
    service_charge: Optional[float] = Field(default=None, description="Service charge in a financial transaction.")
    previous_unpaid_balance: Optional[float] = Field(default=None, description="Previous unpaid balance in a financial transaction.")
    prior_balance: Optional[float] = Field(default=None, description="Prior balance before the current financial transaction.")
    ...
    shipping_handling_charge: Optional[float] = Field(default=None, description="Charge for shipping and handling in a financial transaction.")
...
class FinancialDocumentInformation(BaseModel):
    ...
    barcodes: List[FinancialBarcode] = Field(default_factory=list, description="List of barcodes associated with the document.")

class FinancialDocumentMetadata(BaseModel):
    document_index: Optional[int] = Field(default=None, description="Index of the detected document.")
    document_page_number: Optional[int] = Field(default=None, description="Page number within the document.")
...
class FinancialParserObjectDataClass(BaseModel):
    ...
    item_lines: List[FinancialLineItem] = Field(default_factory=list, description="List of line items associated with the document.")
    document_metadata: FinancialDocumentMetadata

class FinancialParserDataClass(BaseModel):
    extracted_data: List[FinancialParserObjectDataClass] = Field(default_factory=list, description="List of parsed financial data objects (per page).")