...
def custom_document_parsing_async_arguments(provider_name: str) -> Dict:
    ...
    return {
        "file": file_wrapper,
        "queries": [
            {"query": "What is the resume's email address?", "pages": "1-*"},
            {"query": "What is the first Adult Care experience?", "pages": "1"},
        ],
    }
